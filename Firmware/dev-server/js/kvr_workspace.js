...
var WorkSpace = (function () {
    ...
    WorkSpace.prototype.createElement = function (el) {
        ...
        if (el.type == "button") {
            this.createButtonElement(el);
        }
        if (el.type == "slider") {
            this.createSliderElement(el);
        }
    };
    WorkSpace.prototype.createSliderElement = function (el) {
        ...
        div.style.position = "absolute";
        if (el.x)
            div.style.left = "".concat(el.x, "vw");
        if (el.y)
            div.style.top = "".concat(el.y, "vw");
        if (el.w)
            div.style.width = "".concat(el.w, "vw");
        if (el.h)
            div.style.height = "".concat(el.h, "vw");
